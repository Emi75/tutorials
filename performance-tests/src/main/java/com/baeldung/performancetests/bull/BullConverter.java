    ...
    public class BullConverter implements Converter {
        ...
        public Order convert(SourceOrder sourceOrder) {
            FieldTransformer<AccountStatus, com.baeldung.performancetests.model.destination.AccountStatus> accountStatusTransformer = 
                    new FieldTransformer<>("userAccountStatus", userAccountStatus -> new com.baeldung.performancetests.model.destination.User().conversion(sourceOrder.getOrderingUser().getUserAccountStatus()));
